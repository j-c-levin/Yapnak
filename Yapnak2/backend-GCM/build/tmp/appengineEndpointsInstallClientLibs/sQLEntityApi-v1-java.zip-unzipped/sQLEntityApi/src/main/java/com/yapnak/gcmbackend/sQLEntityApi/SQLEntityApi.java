...
public class SQLEntityApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the SQLEntity collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code SQLEntityApi sQLEntityApi = new SQLEntityApi(...);}
   *   {@code SQLEntityApi.SQLEntity.List request = sQLEntityApi.sQLEntity().list(parameters ...)}
   * </pre>
   *
  ...
  /**
   * The "sQLEntity" collection of methods.
   */
  public class SQLEntity {

    /**
     * Create a request for the method "sQLEntity.getUser".
     *
    ...
    public class GetUser extends SQLEntityApiRequest<com.yapnak.gcmbackend.sQLEntityApi.model.PointsEntity> {
      ...
      private static final String REST_PATH = "sqlentity/{userID}";
