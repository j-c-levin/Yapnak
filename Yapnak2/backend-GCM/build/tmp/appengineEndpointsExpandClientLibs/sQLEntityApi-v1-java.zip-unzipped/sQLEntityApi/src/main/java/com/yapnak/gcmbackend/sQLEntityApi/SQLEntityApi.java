...
public class SQLEntityApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetClients getClients(java.lang.Double distance, java.lang.Double x, java.lang.Double y) throws java.io.IOException {
    GetClients result = new GetClients(distance, x, y);
    initialize(result);
    return result;
  }

  public class GetClients extends SQLEntityApiRequest<com.yapnak.gcmbackend.sQLEntityApi.model.ArrayList> {
     ...
     * @since 1.13
     */
    protected GetClients(java.lang.Double distance, java.lang.Double x, java.lang.Double y) {
      super(SQLEntityApi.this, "GET", REST_PATH, null, com.yapnak.gcmbackend.sQLEntityApi.model.ArrayList.class);
    ...
    public GetClients setDistance(java.lang.Double distance) {
