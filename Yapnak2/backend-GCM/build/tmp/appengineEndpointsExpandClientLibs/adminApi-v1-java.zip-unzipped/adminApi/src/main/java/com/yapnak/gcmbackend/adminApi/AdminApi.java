...
public class AdminApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "updateClientHours".
   *
   * This request holds the parameters needed by the adminApi server.  After setting any optional
   * parameters, call the {@link UpdateClientHours#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public UpdateClientHours updateClientHours() throws java.io.IOException {
    UpdateClientHours result = new UpdateClientHours();
    initialize(result);
    return result;
  }

  public class UpdateClientHours extends AdminApiRequest<Void> {

    private static final String REST_PATH = "updateClientHours";

    /**
     * Create a request for the method "updateClientHours".
     *
     * This request holds the parameters needed by the the adminApi server.  After setting any
     * optional parameters, call the {@link UpdateClientHours#execute()} method to invoke the remote
     * operation. <p> {@link UpdateClientHours#initialize(com.google.api.client.googleapis.services.Ab
     * stractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected UpdateClientHours() {
      super(AdminApi.this, "POST", REST_PATH, null, Void.class);
    }

    @Override
    public UpdateClientHours setAlt(java.lang.String alt) {
      return (UpdateClientHours) super.setAlt(alt);
    }

    @Override
    public UpdateClientHours setFields(java.lang.String fields) {
      return (UpdateClientHours) super.setFields(fields);
    }

    @Override
    public UpdateClientHours setKey(java.lang.String key) {
      return (UpdateClientHours) super.setKey(key);
    }

    @Override
    public UpdateClientHours setOauthToken(java.lang.String oauthToken) {
      return (UpdateClientHours) super.setOauthToken(oauthToken);
    }

    @Override
    public UpdateClientHours setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (UpdateClientHours) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public UpdateClientHours setQuotaUser(java.lang.String quotaUser) {
      return (UpdateClientHours) super.setQuotaUser(quotaUser);
    }

    @Override
    public UpdateClientHours setUserIp(java.lang.String userIp) {
      return (UpdateClientHours) super.setUserIp(userIp);
    }

    @Override
    public UpdateClientHours set(String parameterName, Object value) {
      return (UpdateClientHours) super.set(parameterName, value);
    }
  }
