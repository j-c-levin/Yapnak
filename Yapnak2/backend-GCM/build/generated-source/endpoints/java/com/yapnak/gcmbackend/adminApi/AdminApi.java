...
public class AdminApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the AdminEndpoint collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code AdminApi adminApi = new AdminApi(...);}
   *   {@code AdminApi.AdminEndpoint.List request = adminApi.adminEndpoint().list(parameters ...)}
   * </pre>
   *
  ...
  /**
   * The "adminEndpoint" collection of methods.
   */
  public class AdminEndpoint {

    /**
     * Create a request for the method "adminEndpoint.insertPromo".
     *
    ...
    public class InsertPromo extends AdminApiRequest<Void> {
      ...
      private static final String REST_PATH = "void/{promoCode}";
