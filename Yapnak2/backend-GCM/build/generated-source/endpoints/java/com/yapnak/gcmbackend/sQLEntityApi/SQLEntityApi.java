...
public class SQLEntityApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "updateClientInfo".
   *
   * This request holds the parameters needed by the sQLEntityApi server.  After setting any optional
   * parameters, call the {@link UpdateClientInfo#execute()} method to invoke the remote operation.
   *
   * @param email
   * @param name
   * @param type
   * @return the request
   */
  public UpdateClientInfo updateClientInfo(java.lang.String email, java.lang.String name, java.lang.String type) throws java.io.IOException {
    UpdateClientInfo result = new UpdateClientInfo(email, name, type);
    initialize(result);
    return result;
  }

  public class UpdateClientInfo extends SQLEntityApiRequest<com.yapnak.gcmbackend.sQLEntityApi.model.ClientEntity> {

    private static final String REST_PATH = "updateClientInfo";

    /**
     * Create a request for the method "updateClientInfo".
     *
     * This request holds the parameters needed by the the sQLEntityApi server.  After setting any
     * optional parameters, call the {@link UpdateClientInfo#execute()} method to invoke the remote
     * operation. <p> {@link UpdateClientInfo#initialize(com.google.api.client.googleapis.services.Abs
     ...
     * @since 1.13
     */
    protected UpdateClientInfo(java.lang.String email, java.lang.String name, java.lang.String type) {
    ...
    @Override
    public UpdateClientInfo setAlt(java.lang.String alt) {
      return (UpdateClientInfo) super.setAlt(alt);
    }

    @Override
    public UpdateClientInfo setFields(java.lang.String fields) {
      return (UpdateClientInfo) super.setFields(fields);
    }

    @Override
    public UpdateClientInfo setKey(java.lang.String key) {
      return (UpdateClientInfo) super.setKey(key);
    }

    @Override
    public UpdateClientInfo setOauthToken(java.lang.String oauthToken) {
      return (UpdateClientInfo) super.setOauthToken(oauthToken);
    }

    @Override
    public UpdateClientInfo setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (UpdateClientInfo) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public UpdateClientInfo setQuotaUser(java.lang.String quotaUser) {
      return (UpdateClientInfo) super.setQuotaUser(quotaUser);
    }

    @Override
    public UpdateClientInfo setUserIp(java.lang.String userIp) {
      return (UpdateClientInfo) super.setUserIp(userIp);
    }
    ...
    public UpdateClientInfo setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
    ...
    public UpdateClientInfo setName(java.lang.String name) {
      this.name = name;
      return this;
    }
    ...
    public UpdateClientInfo setType(java.lang.String type) {
      this.type = type;
      return this;
    }

    @Override
    public UpdateClientInfo set(String parameterName, Object value) {
      return (UpdateClientInfo) super.set(parameterName, value);
    }
  }
