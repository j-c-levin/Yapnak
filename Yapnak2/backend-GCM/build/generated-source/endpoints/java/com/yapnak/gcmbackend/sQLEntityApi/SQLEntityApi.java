...
public class SQLEntityApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public SetUserDetails setUserDetails(java.lang.String fName, java.lang.String lName, java.lang.Integer number, java.lang.String userID) throws java.io.IOException {
  ...
  public class SetUserDetails extends SQLEntityApiRequest<Void> {
     ...
     * @since 1.13
     */
    protected SetUserDetails(java.lang.String fName, java.lang.String lName, java.lang.Integer number, java.lang.String userID) {
      super(SQLEntityApi.this, "POST", REST_PATH, null, Void.class);
    ...
    public SetUserDetails setNumber(java.lang.Integer number) {
      this.number = number;
      return this;
    }
