...
package com.yapnak.backend.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends UserApiRequest<com.yapnak.backend.userApi.model.User> {
    ...
    protected Get(java.lang.String id) {
      super(UserApi.this, "GET", REST_PATH, null, com.yapnak.backend.userApi.model.User.class);
   ...
   *
   * @param content the {@link com.yapnak.backend.userApi.model.User}
   * @return the request
   */
  public Insert insert(com.yapnak.backend.userApi.model.User content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<com.yapnak.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(com.yapnak.backend.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.yapnak.backend.userApi.model.User.class);
    }
  ...
  public class List extends UserApiRequest<com.yapnak.backend.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, com.yapnak.backend.userApi.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.String id, com.yapnak.backend.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(id, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<com.yapnak.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.String id, com.yapnak.backend.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, com.yapnak.backend.userApi.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.String id, com.yapnak.backend.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(id, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<com.yapnak.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.String id, com.yapnak.backend.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.yapnak.backend.userApi.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
